...
namespace Plugins.Isolationist
{
	public class IsolateInfo : MonoBehaviour
	{
		...
		public static IsolateInfo Instance { get { return _instance ? _instance : (_instance = FindFirstObjectByType<IsolateInfo>()); } set { _instance = value; } }
		...
		public static bool IsIsolated
		{
			get {
				if (!_searched)
				{
					_instance = FindFirstObjectByType<IsolateInfo>();
					_searched = true;
				} 
				return _instance;
			}
