...
if __name__ == '__main__':
    # 示例用法
    # local_file = "/home/hsy/Agi/agent_playground/agent-playground/unity/Build/Linux/linux_unity.zip"
    local_file = '/home/hsy/Agi/agent_playground/agent-playground/unity/Build/Linux/version.json'
